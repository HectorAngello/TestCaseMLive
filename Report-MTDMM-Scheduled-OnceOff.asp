...
<option Value="Airtime">Mobile Money</option>
<option Value="Deductions">Deductions</option>
<option Value="Deposits">Deposits</option>
</select></td></tr>
<tr><td class="quote">Agents:</td><td><select Name="StatusType">
<option Value="1">Only Active Agents</option>
<option Value="2">Only In-Active Agents</option>
<option Value="3">Both Active and In-Active Agents</option>
</select></td></tr>
...
<input type="Hidden" Name="ReportRunID" Value="18">
