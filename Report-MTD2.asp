...
SaveFileName = "MTD_Report-MCharge-" & Day(Now) & Month(Now) & Year(Now) & "-" & Hour(Now) & Minute(Now) & Second(Now) & ".csv"
...
LastTransQry = "EXECUTE SPLastTransAction @TID = " & TID & ", @ctype = 3"
End If

If RepDataType = "Deposits" Then
LastTransQry = "EXECUTE SPLastTransAction @TID = " & TID & ", @ctype = 2"
End If

If RepDataType = "Airtime" Then
LastTransQry = "EXECUTE SPLastTransAction @TID = " & TID & ", @ctype = 1"
End If
...
If RepDataType = "Airtime" Then
RecQuery = "EXECUTE SPTediMTDReportAirtime @TID = " & TID & ", @date1 = '" & StartDate & "', @date2 = '" & EndDate & "'"
...
If RepDataType = "Deposits" Then
RecQuery = "EXECUTE SPTediMTDReportBanking @TID = " & TID & ", @date1 = '" & StartDate & "', @date2 = '" & EndDate & "'"
...
If RepDataType = "Deductions" Then
RecQuery = "EXECUTE SPTediMTDReportDeductions @TID = " & TID & ", @date1 = '" & StartDate & "', @date2 = '" & EndDate & "'"
