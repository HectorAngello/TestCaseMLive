...
If RepDataType = "Airtime" Then
RecQuery = "EXECUTE SPTediMTDReport @TID = " & TID & ", @ctype = 1, @date1 = '" & StartDate & "', @date2 = '" & EndDate & "'"
...
If RepDataType = "Deposits" Then
RecQuery = "EXECUTE SPTediMTDReport @TID = " & TID & ", @ctype = 2, @date1 = '" & StartDate & "', @date2 = '" & EndDate & "'"
...
If RepDataType = "Deductions" Then
RecQuery = "EXECUTE SPTediMTDReport @TID = " & TID & ", @ctype = 3, @date1 = '" & StartDate & "', @date2 = '" & EndDate & "'"
