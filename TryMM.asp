...
RecFetch.Source = "SELECT * FROM MChargeFNBTransMM where Allocated = 'False' Order by FNBDate ASC"
...
RecZoner.Source = "SELECT Top(1) * FROM Tedis Where (TediEmpCode = '" & WhatDS & "') and MobileMoneyTedi = 'True'"
...
function delayer(){
	...
	window.location = "Try-NoPMGInCodeMM.asp"
