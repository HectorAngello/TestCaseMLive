...
RecBulk.Source = "SELECT * FROM BulkMCharge Where BulkID = " & Request.QueryString("BulkID")
        ...
        <div id="main-menu" class="row">
            ...
            <div class="nine columns">
                <div class="content panel">
                        ...
                        <div class="four columns buttons"><a href="Display.asp?AppCat=17&AppSubCatID=33" class="nice white radius button"><p class="new-button">Back</p></a></div>
<br><br><br>Export File Has Been Scheduled For Generation<br><br>
Your File Name is: <%=(RecBulk.Fields.Item("FileName").Value)%>.txt
<br><br><a href="Display.asp?AppCat=17&AppSubCatID=33">Back To M-Charge Bulk File Management</a>
<script language="javascript">      
       //Create an iframe and turn on the design mode for it 
       document.write ('<iframe src="CompileMChargeExport.asp?UN=<%=Session("UNID")%>" id="Abstract" frameborder="0" width="1%" height="1"></iframe>')
