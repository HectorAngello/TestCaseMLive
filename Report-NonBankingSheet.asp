...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td Class="ontab"><h3>Non-Banking Comment / Reason Sheet</h3></td>
  </tr>
  <tr>
    <td align="left" valign="top"><form action="Report-NonBankingSheet2.asp" name="ZRCS" method="get" Target="_parent">
<table>
<tr>
...
<tr><td Align="Center" Colspan="2"><input name="button2" type="submit" class="nice red radius button" id="button2" value="Generate Sheet"></td></tr>
</table>
<input type="hidden" Name="OutFormat" Value="E">
</form></td>
