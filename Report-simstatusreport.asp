...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td><h3>Sim Status Report</h3>
<p><font size=2>Report on the status of sims imported into the system, the date range is based on the date the sims where imported into the system.</font></p>
</td>
  </tr>
  <tr>
    <td align="left" valign="top"><form action="Report-simstatusreport2.asp" name="ZRCS" method="get" Target="_parent">
<table>
