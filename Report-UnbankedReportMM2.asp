...
SaveFileName = "Not-Banked_Report-MobileMoney-" & Day(Now) & Month(Now) & Year(Now) & "-" & Hour(Now) & Minute(Now) & Second(Now) & ".csv"
...
End If
%>
        <h3>Agent Not Banked Report Mobile Money</h3>
...
If IsNull(RecAgentEdit.Fields.Item("LastBankedDateMM").Value) = "False" Then
LastBankedDay = Day(RecAgentEdit.Fields.Item("LastBankedDateMM").Value)
If Len(LastBankedDay) = 1 Then
LastBankedDay = "0" & LastBankedDay
End If
LastBankedMonth = Month(RecAgentEdit.Fields.Item("LastBankedDateMM").Value)
If Len(LastBankedMonth) = 1 then
LastBankedMonth = "0" & LastBankedMonth
End If
LastBankedDate = LastBankedDay & "/" & LastBankedMonth & "/" & Year(RecAgentEdit.Fields.Item("LastBankedDateMM").Value)
