...
If Len(request.querystring("q")) > 3 Then
	sql="SELECT * FROM ViewMyRegionTedis where UserID = " & Session("UNID") & " and  ((TediEmpCode Like '%" & request.querystring("q") & "%')) and TediActive = 'True' and MobileMoneyTedi = 'True' Order By TediEmpCode Asc"
'Response.write(sql)	
