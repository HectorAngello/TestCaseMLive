...
RecTrans.Source = "SELECT * FROM ViewBulkTransactionHistory Where BulkID = " & Request.QueryString("BulkID") & " Order by BulkDate DESC"
...
RecTrans2.Source = "SELECT * FROM BulkMCharge Where BulkID = " & Request.QueryString("BulkID")
