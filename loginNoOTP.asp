...
' Session("DatabasePath") = "Path to your database"
	...
	SQL = "SELECT * FROM ViewUserDetail WHERE username='" & strName & _
...
If Not RecordSet.EOF Then
	...
	struserComp = RecordSet.Fields("CompanyID")
	struserCN = RecordSet.Fields("CompanyName")
...
End If
Session.Timeout=60
	Response.Redirect "Dashboard.asp#Month1"
	Else
