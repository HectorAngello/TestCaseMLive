...
WhatDS2 = WhatDS
%>
<!--#include file="includes/decodeMPMG.inc" -->
...
'RecZoner.Source = "SELECT Top(1) * FROM Tedis Where Replace(TediEmpCode, 'MPMG', '') = '" & WhatDS & "'"
...
function delayer(){
	...
	window.location = "scripts/recalctedibalances.asp"
