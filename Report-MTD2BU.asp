...
If RepDataType = "Airtime" Then
RecQuery = "Select Top(1) * From ViewMTDByTedi where CType = 1 and TediID = " & TID & " and Day(CDate) = " & Day(ListStartDay1) & " and Month(CDate) = " & Month(ListStartDay1) & " and Year(CDate) = " & Year(ListStartDay1)
End If

If RepDataType = "Deposits" Then
RecQuery = "Select Top(1) * From ViewMTDByTedi where CType = 2 and TediID = " & TID & " and Day(CDate) = " & Day(ListStartDay1) & " and Month(CDate) = " & Month(ListStartDay1) & " and Year(CDate) = " & Year(ListStartDay1)
End If

If RepDataType = "Deductions" Then
RecQuery = "Select Top(1) * From ViewMTDByTedi where CType = 3 and TediID = " & TID & " and Day(CDate) = " & Day(ListStartDay1) & " and Month(CDate) = " & Month(ListStartDay1) & " and Year(CDate) = " & Year(ListStartDay1)
End If
