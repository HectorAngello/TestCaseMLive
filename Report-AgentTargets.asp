...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td Class="ontab"><h3>Agent Targets Report</h3></td>
  </tr>
  <tr>
    <td align="left" valign="top"><form action="Report-AgentTargets2.asp" name="ZRCS" method="get" Target="_parent">
<table>
<tr>
...
<tr><td class="quote">Report On:</td><td><select Name="RType">
