...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
    <td align="left" valign="top"><form action="AddToScheduledReport.asp" name="NotBanked" method="Post" Target="_parent">
<table>
<tr>
...
%>
<tr><td class="quote">Run Report Date:</td><td><input type="text" id="datepicker1" Name="ReportDate"  Value="<%=EndDate%>"></td></tr>
...
<input type="Hidden" Name="ReportRunID" Value="19">
