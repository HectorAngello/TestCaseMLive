...
RecReconRegions.Source = "SELECT Distinct RID, RegionName FROM viewUserRegion where Active = 'Yes' and UserID = " & Session("UNID") & " and CompanyID = " & Session("CompanyID") & " Order By RegionName Asc"
...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td Class="ontab"><h3>MIS Report</h3></td>
  </tr>
  <tr>
    <td align="left" valign="top"><form action="Report-MIS2.asp" name="ZRCS" method="get" Target="_parent">
<table>
<tr>
