...
SaveFileName = "MCharge_Exceptions-" & Day(Now) & Month(Now) & Year(Now) & "-" & Hour(Now) & Minute(Now) & Second(Now) & ".csv"
...
RecTrans.Source = "SELECT * FROM View_Opto_UnallocatedFNBTrans_Simple Order by " & OB & " DESC"
