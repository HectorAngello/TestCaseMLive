<!doctype html>
<%
TediPic = Request.Querystring("TediPic")
%>
<html>
<head>
    <meta charset="UTF-8">
    ...
    <div class="main">
        <div class="container"><div class="box">
            <div class="content clearfix">
                <img src="tediimages/<%=Request.Querystring("TediPic")%>" id="avatar2" width="150"><br>
        ...
        $(function() {
            ...
            $('#avatarInline').imgPicker({
                ...
                deleteComplete: function() {
                    $('#avatar2').attr('src', '/tediimages/<%=Request.Querystring("TediPic")%>');
                    this.modal('hide');
                },
		data: function() {
		return {
		    ...
		    window.parent.top.location = "UpdateTediPic.asp?TID=<%=Request.Querystring("TID")%>&NewPic=" + image.versions.avatar.url;
                    this.modal('hide');
                }
            });
